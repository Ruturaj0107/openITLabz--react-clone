                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-6 col-lg-4 text-center course-img">
                                <img src="./assets/python_logo.png" alt="python" />
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="card-body p-4">
                                    <div className="col-lg-12 col-12 text-start mx-auto">
                                        ...
                                        <div className="fnt-clr-txt text-hide" id="content" style={{ whiteSpace: 'pre-line', textAlign: 'justify', maxHeight: showMore ? "100%" : "145px", overflow: 'hidden' }}>
                                            <p className="py-3">A high-level, all-purpose programming language is Python. Code readability is prioritized in its design philosophy, which makes heavy use of indentation.</p>
                                            <p className="py-3">Python uses garbage collection and has dynamic typing. It supports a variety of programming paradigms, including procedural, object-oriented, and functional programming as well as structured programming (especially this). Due to its extensive standard library, it is frequently referred to as a "batteries included" language.</p>
                                        </div>
                                        {!showMore && (
                                            <span id="dot1">
                                                <b>. . .</b>
                                ...
                                <div className="card-body p-4">
                                    <div className="col-lg-12 col-12 text-start mx-auto">
                                        ...
                                        <div className="fnt-clr-txt text-hide" id="content" style={{ whiteSpace: 'pre-line', textAlign: 'justify', maxHeight: showMore1 ? "100%" : "145px", overflow: 'hidden' }}>
                                            <p className="pt-3">• Introduction<br />
                                                • Environment<br />
                                                • Data types<br />
                                                • Decision Loops<br />
                                                • Operators<br />
                                                ...
                                                • Automation : Selenium<br />
                                                • Cloud Deployment Web Apps<br />
                                                • Machine Learning : PySpark<br />
                                                • Artificial Intelligence : TensorFlow<br />
                                            </p>
                                        </div>
                                        {!showMore1 && (
                                            <span id="dot1">
