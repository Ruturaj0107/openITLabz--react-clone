                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-6 col-lg-4 text-center course-img">
                                <img src="./assets/docker_logo.png" alt="docker" />
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="card-body p-4">
                                    <div className="col-lg-12 col-12 text-start mx-auto">
                                        ...
                                        <div className="fnt-clr-txt text-hide" id="content" style={{ whiteSpace: 'pre-line', textAlign: 'justify', maxHeight: showMore ? "100%" : "145px", overflow: 'hidden' }}>
                                            <p className="py-3">Docker Certified Associate Practice Exams teach you everything from the fundamentals to the more advanced concepts, assisting you in passing the Docker Certified Associate Examination while also educating you on the Docker Complete Training, the finest component of the Docker certification.</p>
                                            <p className="py-3">You will be able to grasp Docker and its function within the DevOps lifecycle, build images, containers, swarms, volumes, and networks, define client-server authentication and Docker security client bundles, among other things.</p>
                                        </div>
                                        {!showMore && (
                                            <span id="dot1">
                                                <b>. . .</b>
