                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-6 col-lg-4 text-center course-img">
                                <img src="./assets/azure_logo.png" alt="aws" />
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="card-body p-4">
                                    <div className="col-lg-12 col-12 text-start mx-auto">
                                        ...
                                        <div className="fnt-clr-txt text-hide" id="content" style={{ whiteSpace: 'pre-line', textAlign: 'justify', maxHeight: showMore ? "100%" : "145px", overflow: 'hidden' }}>
                                            <p className="py-3">Do you know what’s common between Samsung and BMW? Both companies use Azure! Azure is a public cloud computing platform offered by Microsoft.</p>
                                            <p>Its solutions can be used for analytics, virtual computing, storage, and networking. It is possible to integrate Azure services into an existing business analytics
                                                practice. You can even execute machine learning with Azure. No wonder, the future of the cloud is Azure!</p>
                                            <p>Microsoft Azure Certification will open up several professional opportunities for you. Career paths include Developer, Architect, Security Professional, and Data
                                                Scientist. Through our Azure fundamentals course, you can develop and deploy applications over Microsoft Azure. This course is ideal for fresh graduates or
                                                professionals who want to shift to the cloud. </p>
                                            <p>OpenITLabz is the best Azure training institute in Pune. We have an exhaustive curriculum with Azure online training
                                                for those who can’t attend the classes in person.</p>
                                        </div>
                                        {!showMore && (
                                            <span id="dot1">
                                                <b>. . .</b>
                                ...
                                <div className="card-body p-4">
                                    <div className="col-lg-12 col-12 text-start mx-auto">
                                        ...
                                        <div className="fnt-clr-txt text-hide" id="content" style={{ whiteSpace: 'pre-line', textAlign: 'justify', maxHeight: showMore1 ? "100%" : "145px", overflow: 'hidden' }}>
                                            <p className="pt-3">Microsoft Certified Azure Administrator Associate AZ 104<br /></p>
                                            <p>• Using Azure Resource Manager templates, automate the deployment of virtual machines (VMs) and modify a template in Azure
                                                Resource Manager<br />
                                                • Configure Azure Container Instances sizing and scaling<br />
                                                • Configure Azure Container Instances container groups<br />
                                                • Configure Azure Container Instances storage (AKS)<br />
                                                • Custom DNS settings and private or public DNS zones can be configured in Azure DNS<br />
                                                • Access secure virtual networks<br />
                                                • Investigate load-balancing issues<br />
                                                • Monitor and troubleshoot virtual networking<br />
                                                • Make security rules</p>
