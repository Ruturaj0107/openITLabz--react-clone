                        ...
                        <div className="row">
                            <div className="col-md-6 col-lg my-auto">
                                <div className="brand">
                                    ...
                                    <p className="text-white fw-bold brand-head" style={{ opacity: '0.75' }}>DevOps allows companies to innovate and competently serve changing markets</p>
                            ...
                            <div className="col-md-6 col-lg-4 text-center course-img">
                                <img src="./assets/devops_logo.png" alt="devops" />
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="card-body p-4">
                                    <div className="col-lg-12 col-12 text-start mx-auto">
                                        ...
                                        <div className="fnt-clr-txt text-hide" id="content" style={{ whiteSpace: 'pre-line', textAlign: 'justify', maxHeight: showMore ? "100%" : "145px", overflow: 'hidden' }}>
                                            <p className="py-3">DevOps is a set of tools and practices that integrate IT processes in a company for the faster deployment of software. In a DevOps model, there is significant collaboration between teams and DevOps engineers have multiple skills. A DevOps engineer must have basic knowledge of all concepts in computer science. So this course is recommended for students or professionals from the IT industry.</p>
                                            <p>OpenITLabz offers DevOps training and placement assistance to kick-start the next phase of your professional life. Possible career paths include DevOps Engineer, DevOps Manager, DevOps Lead, and DevOps Architect. Our DevOps certification course covers tools such as Jenkins, Git, Kubernetes, Prometheus, Terraform, and Docker.</p>
                                            <p>Several leading MNCs around the world use the DevOps model to streamline their IT processes. Some of them are Amazon, Netflix, Adobe, and HP. By undergoing DevOps training in Pune at OpenITLabz you can be a part of these giants. So what are you waiting for? Take DevOps training online or at our institute and understand the methodologies needed to balance the entire software development lifecycle. Embrace automation and drive change!</p>
                                        </div>
                                        {!showMore && (
                                            <span id="dot1">
                                                <b>. . .</b>
                                ...
                                <div className="card-body p-4">
                                    <div className="col-lg-12 col-12 text-start mx-auto">
                                        ...
                                        <div className="fnt-clr-txt text-hide" id="content" style={{ whiteSpace: 'pre-line', textAlign: 'justify', maxHeight: showMore1 ? "100%" : "145px", overflow: 'hidden' }}>
                                            <p className="pt-3">• Introduction to DevOps<br />
