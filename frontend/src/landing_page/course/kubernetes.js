                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-6 col-lg-4 text-center course-img">
                                <img src="./assets/kuberneties_admin_logo.png" alt="kubernetes" />
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="card-body p-4">
                                    <div className="col-lg-12 col-12 text-start mx-auto">
                                        ...
                                        <div className="fnt-clr-txt text-hide" id="content" style={{ whiteSpace: 'pre-line', textAlign: 'justify', maxHeight: showMore ? "100%" : "145px", overflow: 'hidden' }}>
                                            <p className="py-3">As of right now, Kubernetes is one of the most popular cloud computing technologies. The fastest increase in job searches was seen in Kubernetes.Kubernetes usage is skyrocketing as one of the open source projects with the greatest velocity. The Cloud Native Computing Foundation is dedicated to expanding the Kubernetes Administrator community, which will enable ongoing expansion for the vast array of organizations and businesses using Kubernetes.</p>
                                            <p className="py-3">A crucial step in this process is certification, which enables certified administrators to establish their credibility and worth in the labor market rapidly and also enables businesses to more quickly hire high-quality teams to support their growth.</p>
                                        </div>
                                        {!showMore && (
                                            <span id="dot1">
                                                <b>. . .</b>
