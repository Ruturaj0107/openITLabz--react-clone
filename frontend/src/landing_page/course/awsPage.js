                        ...
                        <div className="row">
                            <div className="col-md-6 col-lg my-auto">
                                <div className="brand">
                                    ...
                                    <p className="text-white fw-bold brand-head" style={{ opacity: '0.75' }}>The demand for AWS-certified professionals is increasing all around the world</p>
                                ...
                                <div className="card-body p-4">
                                    <div className="col-lg-12 col-12 text-start mx-auto">
                                        ...
                                        <div className="fnt-clr-txt text-hide" id="content" style={{ whiteSpace: 'pre-line', textAlign: 'justify', maxHeight: showMore ? "100%" : "145px", overflow: 'hidden' }}>
                                            <p className="py-3">Amazon Web Services (AWS) is a cloud platform owned by Amazon and hosted across its global data centers. It offers reliable and scalable cloud computing services.
                                                Now you can get Amazon Web Services training in Pune and leap into the next phase of your career.</p>
                                            <p>Amazon offers an Amazon Web Services Certification after testing the
                                                candidate’s AWS Cloud knowledge, technical skills, and expertise. Possible career paths after AWS certification include Solutions Architects, Cloud Developers, Programmers,
                                                DevOps Professionals, and Cloud Software Engineers.</p>
                                            <p>OpenITLabz is here to help you clear the latest AWS exam and gain the much-coveted digital badge.
                                                Our AWS training institute is different from the rest, as we not only focus on the course but also the placement. We cover all Amazon-designated best practices
                                                in our Amazon Web Services training course. AWS is a serverless platform and it is important to understand the various frameworks, as well as security aspects.
                                                Our course covers all the fundamentals and acquaints you with the various AWS services.</p>
                                            <p>As an AWS Certified Solutions Architect Associate, you will be entrusted with
                                                evaluating different architectural choices. An AWS developer integrates services into a complete solution.</p>
                                        </div>
                                        {!showMore && (
                                            <span id="dot1">
                                                <b>. . .</b>
                                ...
                                <div className="card-body p-4">
                                    <div className="col-lg-12 col-12 text-start mx-auto">
                                        ...
                                        <div className="fnt-clr-txt text-hide" id="content" style={{ whiteSpace: 'pre-line', textAlign: 'justify', maxHeight: showMore1 ? "100%" : "145px", overflow: 'hidden' }}>
                                            <p className="pt-3">1: Design Resilient Architectures<br />
                                                • Design a multi-tier architecture solution<br />
                                                • Design highly available and/or fault-tolerant architectures<br />
                                                • Design decoupling mechanisms using AWS services<br />
                                                • Choose appropriate resilient storage</p>
                                            <p>2: Design High-Performing Architectures<br />
                                                • Identify elastic and scalable compute solutions for a workload<br />
                                                • Select high-performing and scalable storage solutions for a workload<br />
                                                • Select high-performing networking solutions for a workload<br />
                                                • Choose high-performing database solutions for a workload</p>
                                            <p>3: Design Secure Applications and Architectures<br />
                                                • Design secure access to AWS resources<br />
                                                • Design secure application tiers<br />
                                                • Select appropriate data security options</p>
                                            <p>4: Design Cost-Optimized Architectures<br />
                                                • Identify cost-effective storage solutions<br />
                                                • Identify cost-effective compute and database services<br />
                                                • Design cost-optimized network architectures</p>
                                        </div>
                                        {!showMore1 && (
                                            <span id="dot1">
                                                <b>. . .</b>
